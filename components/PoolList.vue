...
import type { UserPoolResponse, SelectPoolAndMembers } from '~/types/responseTypes';
...
const emit = defineEmits(['configurePool']);


const configure = (pool: SelectPoolAndMembers) => {
  emit('configurePool', pool);
};
    ...
    >
      <article class="rounded-lg border border-gray-100 bg-white p-6 mb-2">
        <div class="flex items-center justify-between">
          ...
          <button
            class="rounded-full p-2 cursor-pointer hover:bg-slate-200"
            @click="configure(pool)"
          >
            <svg
